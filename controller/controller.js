...
const functions = {
    ...
    getPopulate : async function(req,res){
    ...
    getHome : async function(req, res){
        ...
        ave = JSON.parse(JSON.stringify(ave))
    ...
    getMyList   : async function(req, res){
    ...
    getBrowse   : async function(req, res){
    ...
    getPlatform : async function(req, res){
    ...
    getViewGame : async function(req, res){
    ...
    postAddList : async function(req, res){
        let game = req.params._id
    ...
    postUpdateStatus    : async function(req, res){
    ...
    postAddReview   : async function(req, res){
